...
void printScoreKimSimonTree(int n, int m, double** logScores, int** dataMatrix, char scoreType){
	...
	// double KimSimonScore = scoreTree(n, m, logScores, dataMatrix, scoreType, parent, -DBL_MAX);   // Salem commented this line and replaced it with one below in order to make compilation easier due to the change of scoreTree function's arguments 
	double KimSimonScore = scoreTreeAccurate(n, m, logScores, dataMatrix, scoreType, parent);   
	cout.precision(20);
