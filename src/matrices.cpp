...
string ancMatrixToString(bool **ancMatrix, int n){
	string outputString = "";
	for(int i=0; i<n; i++)
	{
		for(int j=0; j<n; j++)
		{
			if(ancMatrix[i][j] == true)
				outputString += string("1") + string(" ");
			else
				outputString += string("0") + string(" ");
		}
		outputString += string("\n");
	}
	return outputString;
...
string parVectorToString(int* parVector, int n){
	string outputString = "";
	for(int i=0; i<n; i++)
		outputString += to_string(parVector[i]) + string(" ");
	outputString += string("\n");
